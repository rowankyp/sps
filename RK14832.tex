...
the features are detailed in section 3
...
\justifying{
    ...
    regions of the as shown in figures 1 to 3.
...
\section{Results of Fourier Domain analysis and analysis of the classifier}
    ...
    \justifying{
        ...
        \textit{fig 6} shows the resulting assignment of the characters seen above. Referring first to the Ss,
